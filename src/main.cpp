...
unsigned char NroCiclos = 3;      // Número de ciclos de carga
...
/*********** Variables para la función de interupción del contador ***************/
...
/*
* Función para parpadeo de led cada segundo, esta rutina tiene como 
* proposito usar el led del pin 13 del arduino como un indicador para 
* el cambio de estado por la llamada de la interrupción que está 
* programada para cada un segundo.
*/
...
/*
* La función compara la variable conteo que se actualiza cada segundo por
* la llamada de interrupción, al llegar a 59 incrementa la variable 
* ContMin para así llevar la cuenta del tiempo transcurrido desde que se
* invoca la funcion.
*/
...
* permitiendo incrementar los contadores correspondientes
*/
void IntSeg(void) 
...
/*
* imprime en display la variable tiempo de carga del programa.
*/
...
/*
* imprime en display la variable tiempo de reposo del programa.
*/
...
/*
* imprime en display la variable número de ciclos del programa.
*/
...
/*
* Función de configuración del arduino uno
*/
void setup() 
{
